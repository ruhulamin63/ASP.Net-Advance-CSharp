    ...
    public partial class AdminDashboard : Form
    {
        ...
        private void ticketsGridView_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                {
                    MessageBox.Show("You cannot modify or delete previous Tickets", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    reloadTickets();
                    return;
                }
        ...
        private void adminAddBtn_Click(object sender, EventArgs e)
        {
            ...
            if (res) { reloadAdmin(); MessageBox.Show("Admin added", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information); }
        }
        ...
        private void adminSearchBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Admin not found", "Message", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }
        ...
        private void adminDeleteBtn_Click(object sender, EventArgs e)
        {
            ...
            if (res) { reloadAdmin(); MessageBox.Show("Admin deleted", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information); }
        }
        ...
        private void adminUpdateBtn_Click(object sender, EventArgs e)
        {
            ...
            if(res) { reloadAdmin(); MessageBox.Show("Admin updated", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information); }
        }
